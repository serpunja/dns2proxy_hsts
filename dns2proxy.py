...
Example:
python dns2proxy.py -i wlan0 -u 192.168.1.101 -d 192.168.1.200

Example for no forwarding (only configured domain based queries and spoofed hosts):
  python2.6 dns2proxy.py -i wlan0 -noforward

Example for no forwarding but add IPs
  python dns2proxy.py -i wlan0 -I 192.168.1.101,90.1.1.1,155.54.1.1 -noforward
